...
import { Body, Controller, Get, Logger, Post,Patch, Param, Delete, Query, Put } from "@nestjs/common";
...
export class BoardController{
    ...
    @Get()
    async findAll(@Query() filter: BoardFilterDto, @Pagination() Pagination: PaginationOptions) {
        try {
    ...
    async addMember(@Param('idmember') idMember:string , @Param('idboard') idBoard:string){
        try {
    ...
    async removeMember(@Param('idmember') idMember:string , @Param('idboard') idBoard:string){
        try {
